...
def create_model(cfg, device): #device es el dispositivo CPU o GPU donde se ejecutará el modelo
    ...
    pannuke_model = "https://drive.google.com/u/1/uc?id=1SbSArI3KOOWHxRlxnjchO7_MbWzB4lNR&export=download"
    ...
    if cfg["stage"] == 0:
        model = HoVerNet( #https://docs.monai.io/en/stable/networks.html
            ...
            norm="batch",
            pretrained_url=pannuke_model, #solo se usa en la primera etapa
...
def main():
    ...
    parser.add_argument("--log-dir", type=str, default="/home/rmartin/projects/Deep_INGENIO/logs_exp4", help="log directory")
