...
def run(cfg):
    ...
    data_list = [{"image": image} for image in glob(os.path.join(cfg["root"], "*.jpg"))]
...
def main():
    ...
    parser.add_argument(
        "--root",
        type=str,
        #default= "/home/rmartin/projects/Deep_INGENIO/11ROICompleta",
        default = "/home/rmartin/projects/Deep_INGENIO/parches_ROI/Ring2vuelta_8",
        help="Images root dir",
    )
    parser.add_argument("--output", type=str, default="/home/rmartin/projects/Deep_INGENIO/OUTPUT_RING/RING28", dest="output", help="log directory")
    parser.add_argument(
        "--ckpt",
        type=str,
    ...
    parser.add_argument("--out-classes", type=int, default=4, help="number of output classes")
    parser.add_argument("--bs", type=int, default=1, dest="batch_size", help="batch size")
    parser.add_argument("--swbs", type=int, default=10, dest="sw_batch_size", help="sliding window batch size")
