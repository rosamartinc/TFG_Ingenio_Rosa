...
from cellseg_models_pytorch.models.cellvit.cellvit import cellvit_sam_base #https://github.com/okunator/cellseg_models.pytorch/blob/main/cellseg_models_pytorch/models/cellvit/cellvit.py 
...
def run(log_dir, cfg):
    ...
    train_transforms = Compose(
        [
            ...
            Lambdad(keys="label_type", func=transform_values),
            ...
            AsDiscreted(keys=["label_type"], to_onehot=[3]),
...
def main():
    ...
    parser.add_argument(
        ...
        default="/home/rmartin/projects/Deep_INGENIO/parches_root",
        help="root data dir",
    )
    #parser.add_argument("--log-dir", type=str, default="./logs/", help="log directory")
    parser.add_argument("--log-dir", type=str, default="/home/rmartin/projects/Deep_INGENIO/logs_exp2", help="log directory")
    ...
    parser.add_argument("--classes", type=int, default=3, dest="out_classes", help="output classes")
